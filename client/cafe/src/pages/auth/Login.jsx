    ...
    <div>
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <div className="text-right">
          <Link to="/forgot-password" className="text-gray-600 hover:underline text-sm font-medium">
            Forgot Password?
          </Link>
        </div>
      ...
      <div className="text-center mt-6 pt-4 border-t border-gray-100">
        ...
        <Link to="/auth/register" className="font-semibold hover:underline" style={{ color: '#4a3a2f' }}>
          Sign Up
        </Link>
      </div>
    </div>
