...
// Loader component is now defined inside this file to resolve the import error.
const Loader = () => (
    <div className="fixed inset-0 bg-white bg-opacity-75 flex items-center justify-center z-50">
        <div className="w-16 h-16 border-4 border-dashed rounded-full animate-spin border-[#4a3a2f]"></div>
    </div>
);
