...
export default function CafeApprovalQueuePage() {
    ...
    const fetchPendingCafes = async () => {
        try {
            const response = await axios.get("/api/admin/cafes/pending");
    ...
    const handleApprove = async (cafeId) => {
        try {
            const response = await axios.put(`/api/admin/cafes/${cafeId}/approve`);
    ...
    const handleReject = async (cafeId, reason) => {
        ...
        try {
            const response = await axios.delete(`/api/admin/cafes/${cafeId}/reject`);
            toast.success(response.data.message);
