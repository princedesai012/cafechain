        ...
        <div className="bg-white min-h-screen w-full font-sans text-[#4A3A2F]">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="flex items-center gap-2">
                            <button onClick={() => navigate('/login')} className="px-5 py-2 text-sm font-semibold rounded-full hover:bg-gray-100 transition">Login</button>
                            <button onClick={() => navigate('/register')} className="px-5 py-2 text-sm font-semibold bg-[#4A3A2F] text-white rounded-full hover:bg-opacity-90 transition">Register</button>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <section className="relative pt-32 pb-24 bg-gradient-to-br from-[#4A3A2F] via-[#3B2D25] to-[#2A1F18] overflow-hidden">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 text-center">
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
                            <button onClick={() => navigate('/register')} className="bg-amber-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-amber-700 transition shadow-lg transform hover:scale-105">
                                Join the Club
                            </button>
                        </motion.div>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="bg-stone-100 rounded-2xl grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden">
                            <div className="p-10 lg:p-16">
                                ...
                                <button onClick={() => navigate('/cafes')} className="font-bold text-lg text-[#4A3A2F] flex items-center gap-2 hover:gap-3 transition-all">
            ...
            <footer className="bg-[#4A3A2F] text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
                    ...
                    <button onClick={() => navigate('/register')} className="bg-white text-[#4A3A2F] px-8 py-3 rounded-full font-bold hover:bg-gray-200 transition shadow-lg">Get Started Now</button>
